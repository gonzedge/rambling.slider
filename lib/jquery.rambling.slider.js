  ...
  (function($) {
    ...
    RamblingSlider = function(element, options) {
      ...
      ramblingRun = function(slider, kids, settings, nudge) {
        /*
              Get our vars
              */        var animate, animation, animation_callbacks, animation_options, anims, box2Darr, boxes, colIndex, cols, current_effect, current_effect_options, firstSlice, rowIndex, slices, timeBuff, totalBoxes, v, _ref2, _results;
