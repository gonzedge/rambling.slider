  ...
  */
  (function($) {
    ...
    return RamblingSlider = function(element, options) {
      var anims, clearTimer, controlNavAnchors, createBoxes, createSlices, directionNav, i, kid, kids, processCaption, ramblingAnimationContainer, ramblingControl, ramblingRun, self, setCurrentImage, settings, slideTo, slider, timer, vars, _fn, _ref;
      self = this;
      slider = $(element);
      ...
      createSlices = function(slider, settings, vars) {
        ...
        for (i = 0, _ref = settings.slices; 0 <= _ref ? i < _ref : i > _ref; 0 <= _ref ? i++ : i--) {
          _results.push((function(i) {
            ...
            return animationContainer.append(self.getRamblingSlice(sliceWidth, i, settings.slices, vars));
          })(i));
        }
        return _results;
      };
          ...
          _results.push((function(rows) {
            ...
            for (cols = 0, _ref2 = settings.boxCols; 0 <= _ref2 ? cols < _ref2 : cols > _ref2; 0 <= _ref2 ? cols++ : cols--) {
              _results2.push((function(cols) {
                ...
                return animationContainer.append(self.getRamblingBox(boxWidth, boxHeight, rows, cols, settings, vars));
              })(cols));
            }
            return _results2;
          })(rows));
      ...
      (function() {
        var getBox, getSlice;
        this.setSliderBackground = function(slider, vars) {
          return slider.css({
            background: "url(" + (vars.currentImage.attr('src')) + ") no-repeat"
          });
        };
        this.getRamblingSlice = function(sliceWidth, position, total, vars) {
        ...
        this.getRamblingBox = function(boxWidth, boxHeight, row, column, settings, vars) {
        ...
        if (settings.adaptImages) {
          getSlice = this.getRamblingSlice;
          getBox = this.getRamblingBox;
          this.setSliderBackground = function() {
      ...
      /*
          ...
          */
      this.setSliderBackground(slider, vars);
      /*
          Create caption
          */
      ...
      ramblingRun = function(slider, kids, settings, nudge) {
        /*
              Get our vars
              */        var animate, animation, animation_callbacks, animation_options, boxes, callbacks, current_animation, current_effect, current_effect_options, firstSlice, slices, timeBuff, totalBoxes, v;
