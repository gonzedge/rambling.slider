(function() {
  ...
  */  (function($) {
    ...
    RamblingSlider = function(element, options) {
      /*
          Defaults are below
          */      var adaptImagesFunctions, clearTimer, createBoxes, createSlices, defaultFunctions, functions, i, kids, liveWith, processCaption, ramblingControl, ramblingRun, settings, shuffle, slider, timer, trace, vars, _fn, _ref;
      ...
      createSlices = function(slider, settings, vars) {
        ...
        for (i = 0, _ref2 = settings.slices - 1; 0 <= _ref2 ? i <= _ref2 : i >= _ref2; 0 <= _ref2 ? i++ : i--) {
          _results.push((function(i) {
            ...
            return slider.append(functions.getRamblingSlice(sliceWidth, i, settings.slices, vars));
          })(i));
        }
        return _results;
      };
          ...
          _results.push((function(rows) {
            ...
            for (cols = 0, _ref3 = settings.boxCols - 1; 0 <= _ref3 ? cols <= _ref3 : cols >= _ref3; 0 <= _ref3 ? cols++ : cols--) {
              _results2.push((function(cols) {
                return slider.append(functions.getRamblingBox(boxWidth, boxHeight, rows, cols, settings, vars));
              })(cols));
            }
            return _results2;
          })(rows));
