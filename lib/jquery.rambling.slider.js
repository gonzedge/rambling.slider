  ...
  */
  (function($) {
    ...
    return RamblingSlider = function(element, options) {
      ...
      getSlice = function(sliceWidth, position, total, vars) {
      ...
      setSliderBackground = function() {
        ...
        if (!slider.find('.currentSlideElement').replaceWith(image).length) {
          return slider.find('#rambling-animation').prepend(image);
        }
      };
