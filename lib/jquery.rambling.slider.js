  ...
  */
  (function($) {
    ...
    RamblingSlider = function(element, options) {
      /*
          Defaults are below
          */      var adaptImagesFunctions, clearTimer, controlNavAnchors, createBoxes, createSlices, defaultFunctions, directionNav, functions, i, kid, kids, liveWith, processCaption, ramblingAnimationContainer, ramblingControl, ramblingRun, settings, slider, timer, trace, vars, _fn, _ref;
