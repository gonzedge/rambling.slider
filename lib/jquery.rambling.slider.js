    ...
    return RamblingSlider = function(element, options) {
      ...
      prepareSliderChildren = function() {
        ...
        children.each(function() {
          ...
          return ramblingAnimationContainer.append(child.clone().addClass('slideElement'));
        });
