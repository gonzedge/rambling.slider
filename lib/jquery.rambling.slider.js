  ...
  (function($) {
    ...
    return RamblingSlider = function(element, options) {
      ...
      effect = function() {
        ...
        animationsToRun = ['sliceDownRight', 'sliceDownLeft', 'sliceUpRight', 'sliceUpLeft', 'sliceUpDown', 'sliceUpDownLeft', 'foldRight', 'foldLeft', 'fade', 'slideInRight', 'slideInLeft', 'rolloverRight', 'rolloverLeft', 'boxRandom', 'boxRain', 'boxRainReverse', 'boxRainGrow', 'boxRainGrowReverse'];
