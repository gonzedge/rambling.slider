  ...
  */  (function($) {
    ...
    RamblingSlider = function(element, options) {
      ...
      ramblingRun = function(slider, kids, settings, nudge) {
        /*
              Get our vars
              */        var animation, animation_callbacks, anims, box2Darr, boxes, colIndex, cols, current_effect, firstSlice, rowIndex, sliceStyle, slices, timeBuff, totalBoxes, v, _ref2, _results;
