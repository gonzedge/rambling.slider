  ...
  */
  (function($) {
    ...
    return RamblingSlider = function(element, options) {
      var adaptImagesFunctions, anims, clearTimer, controlNavAnchors, createBoxes, createSlices, defaultFunctions, directionNav, functions, i, kid, kids, liveWith, processCaption, ramblingAnimationContainer, ramblingControl, ramblingRun, setCurrentImage, settings, slider, timer, trace, vars, _fn, _ref;
      timer = 0;
