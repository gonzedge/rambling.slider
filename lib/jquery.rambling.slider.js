(function() {
  ...
  */
  ...
  (function($) {
    ...
    return RamblingSlider = function(element, options) {
              ...
              for (row = 0, _ref2 = settings.boxRows; 0 <= _ref2 ? row < _ref2 : row > _ref2; 0 <= _ref2 ? row++ : row--) {
                _results2.push((function(row) {
                  ...
                  if (column >= 0 && column < settings.boxCols) {
                    ...
                    window.setTimeout((function() {
                      return box.animate(animationSetUp.apply(box), settings.speed / 1.3, '', finishedCallback);
                    }), 100 + animationTimeBuffer);
                    index++;
      ...
      rainBoxes = function(sortCallback) {
        return animateBoxesIn2d(function(finishedCallback) {
          return {
            opacity: '1'
          };
        });
  ...
  (function($) {
    ...
    return $.fn.ramblingSlider.defaults.transitionGroupSuffixes = ['Right', 'Left', 'OutIn', 'InOut', 'Random', 'Reverse', 'In', 'Out'];
  })(jQuery);
}).call(this);
