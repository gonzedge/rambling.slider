  ...
  */
  ...
  RamblingBoxGenerator = (function() {
    ...
    RamblingBoxGenerator.prototype.createBoxes = function(boxCols, boxRows) {
      ...
      _fn = __bind(function(rows) {
        var cols, _results;
        _results = [];
        for (cols = 0; 0 <= boxCols ? cols < boxCols : cols > boxCols; 0 <= boxCols ? cols++ : cols--) {
          _results.push(__bind(function(cols) {
            return animationContainer.append(this.boxer.getRamblingBox(boxWidth, boxHeight, rows, cols, this.settings, this.vars));
          }, this)(cols));
        }
        return _results;
      }, this);
