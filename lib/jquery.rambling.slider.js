(function() {
  ...
  */
  ...
  (function($) {
    ...
    return $.fn.containsFlash = function() {
  ...
  (function($) {
    ...
    return RamblingSlider = function(element, options) {
      var addCaption, addControlNavigation, addDirectionNavigation, addKeyboardNavigation, animateBoxes, animateFullImage, animateSlices, animationTimeBuffer, children, createBoxes, createSlices, destroy, effect, flashTransitions, foldSlices, getAnimationsForCurrentSlideElement, getBox, getOneSlice, getRamblingBox, getRamblingSlice, getRandomAnimation, getSlice, imageTransitions, initialize, nextSlide, option, pauseSlider, prepareAdaptiveSlider, prepareAnimationContainer, prepareSliderChildren, previousSlide, processCaption, rainBoxes, ramblingRun, randomBoxes, resetTimer, run, setAnimationFinishedActions, setCurrentSlideElement, setSliderBackground, setSliderInitialState, settings, slide, slideDownSlices, slideTo, slideUpDownSlices, slideUpSlices, slider, start, stop, timer, transitionOptions, unpauseSlider, vars;
      slider = $(element);
      ...
      getAnimationsForCurrentSlideElement = function() {
        var defaultTransition, sourceTransitions, transitions;
        transitions = [];
        sourceTransitions = [];
        ...
        if (settings.effect !== 'random') {
          transitions = transitions.where(function(animationName) {
            return settings.effect.split(',').contains(animationName);
          });
        }
      ...
      getSlice = function(sliceWidth, position, total, vars, slideElement) {
        var background, imageSrc, sliceCss, width;
      ...
      getBox = function(boxWidth, boxHeight, row, column, settings, vars) {
        var background, boxCss, imageSrc, width;
      ...
      imageTransitions = {
        ...
        fade: function() {
          return imageTransitions.fadeIn;
        },
        fadeIn: function() {
      ...
      flashTransitions = {
        ...
        slideIn: function() {
          ...
          return window.setTimeout((function() {
            return vars.currentSlideElement.animate({
              left: '0'
            }, settings.speed * 2, function() {
              return vars.currentSlideElement.css({
                top: 'auto',
                left: 'auto',
                position: 'relative'
              });
