  ...
  */
  (function($) {
    ...
    RamblingSlider = function(element, options) {
      /*
          Defaults are below
          */      var adaptImagesFunctions, clearTimer, createBoxes, createSlices, defaultFunctions, functions, i, kids, liveWith, processCaption, ramblingAnimationContainer, ramblingControl, ramblingRun, settings, slider, timer, trace, vars, _fn, _ref;
      ...
      ramblingRun = function(slider, kids, settings, nudge) {
        ...
        if (settings.effect === 'sliceDown' || settings.effect === 'sliceDownRight' || vars.randAnim === 'sliceDownRight' || settings.effect === 'sliceDownLeft' || vars.randAnim === 'sliceDownLeft') {
          ...
          if (settings.effect === 'sliceDownLeft' || vars.randAnim === 'sliceDownLeft') {
            slices = $('.rambling-slice', slider).reverse();
          }
