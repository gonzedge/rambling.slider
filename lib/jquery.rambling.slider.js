  ...
  */
  (function($) {
    ...
    return RamblingSlider = function(element, options) {
      var anims, clearTimer, controlNavAnchors, createBoxes, createSlices, directionNav, getBox, getRamblingBox, getRamblingSlice, getSlice, i, kid, kids, processCaption, ramblingAnimationContainer, ramblingControl, ramblingRun, setCurrentImage, setSliderBackground, settings, slideTo, slider, timer, vars, _fn, _ref;
      slider = $(element);
      ...
      slider.find('.rambling-caption').hide();
