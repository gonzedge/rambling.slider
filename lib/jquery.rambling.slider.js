    ...
    return RamblingSlider = function(element, options) {
      ...
      animateSlices = function(animationCallback, reorderCallback) {
        ...
        return slices.each(function(index, element) {
          return animationCallback.apply(this, [index, element, raiseAnimationFinished]);
        });
      };
      ...
      slideDownSlices = function(reorderCallback) {
        return animateSlices(function(index, element, finishedCallback) {
          var slice;
          slice = $(element);
          slice.css({
            top: '0px'
