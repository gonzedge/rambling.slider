  ...
  */
  ...
  (function($) {
    ...
    return RamblingSlider = function(element, options) {
      ...
      animateSlices = function(sortCallback, animationSetUp) {
        var slices;
        slices = createSlices();
        animationTimeBuffer = 0;
        if (sortCallback) {
      ...
      slideDownSlices = function(sortCallback) {
        return animateSlices(sortCallback, function(index, element) {
          this.css({
            top: '0px'
          });
          return {
      ...
      imageTransitions = {
        ...
        fadeIn: function() {
          return animateFullImage(animationSetUp.fadeIn);
        },
        fadeOut: function() {
          return animateFullImage(animationSetUp.fadeIn);
        },
        slideInRight: function() {
          return animateFullImage(animationSetUp.slideInRight);
        },
        slideInLeft: function() {
          return animateFullImage(animationSetUp.slideInLeft);
        },
        rolloverRight: function() {
          return animateFullImage(animationSetUp.rolloverRight);
        },
        rolloverLeft: function() {
          return animateFullImage(animationSetUp.rolloverLeft);
        },
      ...
      imageFlashTransitions = {
        fadeOut: function() {
          ...
          setSliderBackground();
          return slice.animate(animate, settings.speed * 2, '', function() {
            if (settings.afterChange) {
              settings.afterChange.apply(slice);
            }
            slice.css({
