(function() {
  ...
  */
  ...
  (function($) {
    var allAroundTransitions, animationSetUp, flashHorizontalSlideIn, flashSlideIn, settings, slider;
    slider = null;
    settings = null;
    ...
    $.fn.ramblingSlider.defaults.imageTransitions = {
      ...
      boxRainInOut: function() {
        return this.rainBoxes($.fn.sortInOut);
      },
      ...
      boxRainGrowInOut: function() {
        return this.rainBoxes($.fn.sortInOut, true);
      }
    };
    $.each(allAroundTransitions, function(index, transition) {
      return $.each(allAroundTransitions.suffixes, function(index, suffix) {
    ...
    $.each(allAroundTransitions, function(index, element) {
      return $.fn.ramblingSlider.defaults.transitionGroups.push(element);
    });
    return $.fn.ramblingSlider.defaults.transitionGroupSuffixes = ['Right', 'Left', 'OutIn', 'InOut', 'Random', 'In', 'Out'];
  })(jQuery);
}).call(this);
